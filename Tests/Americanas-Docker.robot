*** Settings ***
Documentation      This test suite validates the actions of search, add and remove product. Configured to run on Docker container.
Resource  ../Resources/Common/Common-WEB-Docker.robot
